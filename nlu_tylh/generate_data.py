...
SLOT_LIST = ['S_ATTR', 'S_OPE', 'S_LOC', 'S_NAME']
...
def process(raw_file):
    ...
    for i in range(0, len(lines)):
        ...
        print(sent_tmp)
        S_ATTR_tmp, S_OPE_tmp, S_LOC_tmp, S_NAME_tmp = tmp[2], tmp[3], tmp[4], tmp[5]
        INTENT_tmp = tmp[1]
        print(S_ATTR_tmp, S_OPE_tmp, S_LOC_tmp, S_NAME_tmp, INTENT_tmp)
        sents.append(' ' + sent_tmp + ' ' + '\n')
        slots1.append(' ' + S_ATTR_tmp + ' ' + '\n')
        slots2.append(' ' + S_OPE_tmp + ' ' + '\n')
        slots3.append(' ' + S_LOC_tmp + ' ' + '\n')
        slots4.append(' ' + S_NAME_tmp + ' ' + '\n')
