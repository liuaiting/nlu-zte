...
class MultiTaskModel(object):
    ...
    def __init__(self,
        ...
        with tf.name_scope("embedding"):
            ...
            #
            # embedding.metadata_path = 'model/embedding_meta.tsv'
            # summary_writer = tf.summary.FileWriter('model/')
        ...
        with tf.name_scope("save"):
            ...
            self.train_writer = tf.summary.FileWriter('model', self.session.graph)
            # self.test_writer = tf.summary.FileWriter('model', self.session.graph)
    # @property
    # def input(self):
    #     return self.inputs
    #
    ...
    def step(self, inputs, s_attrs, s_locs, s_names, s_opes, s_ways, intents,
        ...
        if not forward_only:
            return outputs[0], outputs[3], outputs[4:]  # Merged summary, loss, no outputs.
        else:
